...
<br>
<g:form resource="${this.demande}" method="POST" class="form-horizontal form-normal form-left" action="save">
    <h3 style="color: #ff8000;">Demande de formation</h3>
    ...
    <div class="col-md-7 col-lg-7">
        ...
        <div class="row">
            ...
            <input  type="hidden" class="form-control " id="status" name="status"  value="${demande?.status}"  >
        </div>
    </div>
</g:form>
