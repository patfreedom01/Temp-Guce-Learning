...
<g:applyLayout name="main">
    ...
    <div class="py-5">
        <h2 style="color : #ff8000 ">Inscription à une formation</h2>
        <p class="lead">Veuillez remplir le formulaire ci-dessous pour inscrire à une formation planifiée.</p>
    </div>
    <div class="row g-5">
        <br>
        <g:form resource="${this.demande}" method="POST">
            <div class="col-md-7 col-lg-7">
                <div class="row">
                    <div class="col-md-6">
                        <f:all bean="demande" order="module" name="module" id="module"/>
                        <br>
                        <f:all bean="demande" order="formation" name="formation" id="formation"/>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control mb-3" id="nom" name="nom" placeholder="" value="${demande?.nom}" >
                    </div>
                    <div class="col-md-4">
                        <label for="telephone" class="form-label">N°Téléphone</label>
                        <input type="text" class="form-control mb-3" id="telephone" name="telephone" placeholder="" value="${demande?.telephone}" >
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <input type="email" class="form-control " id="email" name="email" placeholder="adresse@exemple.com" value="${demande?.email}">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select class="wfinput col-md-2 form-control form-input form-input-0" name="typePartrnaire" id="typePartrnaire"  value="${demande?.typePartrnaire}" >
                            <option value=""> -- choix -- </option>
                            <option value="operateurEconomique">Opérateur Economique</option>
                            <option value="ministereTechnique">Ministrère Technique</option>
                        </select>
                    </div>
                    <br>
                    <br>
                ...
                <br>
                <g:submitButton name="create" class="save w-50 d-grid gap-2 col-md-3 mx-auto btn btn-success btn-lg" value="${message(code: 'default.button.create.label', default: 'Create')}" />
            </div>
        </g:form>
