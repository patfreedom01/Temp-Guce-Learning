            ...
            <ul class='nav nav-pills'>
                <div>
                    <g:form method="DELETE" controller="demande" action="delete" id="${params.id}">
                        ...
                        <g:link class="edit btn btn-success" style = "border : none;" action="editHelpDk" resource="${this.demande}"><g:message code="Modifier" default="Modifier" /></g:link>
                        <g:link class="edit btn btn-success" style = "border : none;" action="edit" resource="${this.demande}"><g:message code="Modifier" default="Modifier" /></g:link>
