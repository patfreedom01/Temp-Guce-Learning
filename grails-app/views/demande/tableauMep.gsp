                    ...
                    <td>
                        <div class="actions">
                            <g:form method="DELETE" controller="demande" action="delete" id="${thisDemande.id}">
                                ...
                                <g:link controller="demande" title="Afficher" action="showMep" id="${thisDemande.id}" method="POST" >
                                    <i  >
                                        <span class='glyphicon glyphicon-eye-open'></span>
                                    </i>
                                </g:link>
                                <g:link controller="demande"  title="Mettre à jour" action="editMep" id="${thisDemande.id}" method="POST" >
                                    <i  >
