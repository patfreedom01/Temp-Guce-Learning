<br>
<g:form resource="${this.inscription}" method="POST" class="form-horizontal form-normal form-left" action="save">
    <h3 style="color : #ff8000 ">Inscription à une formation</h3>
    <p class="lead">Veuillez remplir les champs ci-dessous pour vous inscrire à une de planifier une formation.</p>
    ...
    <div class="col-md-7 col-lg-7">
        <div class="row g-3">
            <div class="col-md-8">
%{--                <f:all bean="inscription" order="formationDisponible" />--}%
                <label for="formationDisponible" class="form-label">Formations Disponibles</label>
                <select class="wfinput col-md-2 form-control form-input form-input-0" name="formationDisponible" id="formationDisponible"  value="${inscription?.formationDisponible}" >
                    <g:each in="${this.formations}" var="thisFormation" >
%{--                        <option value="${thisFormation.id}"> ${thisFormation} </option>--}%
%{--                        <option value="${thisFormation.id}"> "Module "+module+" programmé le "+dateFormtation+" à "+heureDebut </option>--}%
%{--                        <option value="${thisFormation.id}"> Module ${thisFormation.module} programmé le ${thisFormation.dateFormtation.dateString} à ${thisFormation.heureDebut} </option>--}%
                        <option value="${thisFormation.id}"> Module ${thisFormation.module} programmé le ${thisFormation.dateFormtation.dateString} à ${thisFormation.heureDebut} </option>
                    </g:each>
                </select>
        ...
        <br>
        <h4 class="mb-2">Vos coordonnées</h4>
        <div class="row">
            <div class="col-md-6">
                <label for="nom" class="form-label">Nom & Prénoms</label>
                <input type="text" class="form-control mb-3" id="nom" name="nom" placeholder="" value="${inscription?.nom}" required>
            </div>
            <div class="col-md-4">
                <label for="telephone" class="form-label">N°Téléphone</label>
                <input type="text" class="form-control mb-3" id="telephone" name="telephone" placeholder="" value="${inscription?.telephone}" required>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-md-10">
                ...
                <input type="email" class="form-control " id="email" name="email" placeholder="adresse@exemple.com" value="${inscription?.email}" required>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-md-6">
                ...
                <select class="wfinput col-md-2 form-control form-input form-input-0" name="typePartrnaire" id="typePartrnaire"  value="${inscription?.typePartrnaire}" required>
            ...
            <br>
            <div class="col-md-8">
                <textarea class="form-control" name="commentaire" id="exampleFormControlTextarea1" rows="3"  placeholder="Un commentaire ?" value="${inscription?.commentaire}" ></textarea>
            </div>

            <div class="col-md-4">
                <input  type="hidden" class="form-control " id="status" name="status"  value="${inscription?.status}"  >
            </div>
