...
<body>
<br>
<g:form resource="${this.inscription}" method="PUT" class="form-horizontal form-normal form-left" action="update">
    ...
    <div class="col-md-7 col-lg-7">
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <input type="email" class="form-control " id="email" name="email" placeholder="adresse@exemple.com" value="${inscription?.email}" >
            </div>
        </div>
        <br>
        <div class="row">
