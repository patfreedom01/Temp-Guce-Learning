...
<body>
<br>
<g:form resource="${this.inscription}" method="PUT" class="form-horizontal form-normal form-left" action="updateMep">
    ...
    <g:link controller="inscription" action="tableauMep" class='btn btn-default' name='close' title='Fermer'>Fermer</g:link>
    </div>
</ul>
</div>
</div>
    <div class="col-md-10 col-lg-10">
        <div class="row">
            ...
            <br>
            <div class="col-md-4">
                <f:all  bean="inscription" order="status"/>
            </div>
        </div>
