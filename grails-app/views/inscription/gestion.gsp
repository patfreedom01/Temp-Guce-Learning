...
<body>
<br>
<g:form resource="${this.inscription}" method="PUT" class="form-horizontal form-normal form-left" action="save">
    <h3 style="color : #ff8000 ">Modifier Inscription</h3>
    <p class="lead">Veuillez remplir les champs ci-dessous pour modifer votre inscription.</p>
...
%{--                <textarea class="form-control" name="commentaire" id="exampleFormControlTextarea1" rows="3"  placeholder="Un commentaire ?" value="${inscription?.commentaire}" ></textarea>--}%
            ...
            <div class="col-md-4">
                <input  type="te" class="form-control " id="status" name="status"  value="${inscription?.status}"  >

                <label class="form-label">Status</label>
                <select class="wfinput col-md-2 form-control form-input form-input-0" name="typePartrnaire" id="typePartrnaire"  value="${inscription?.typePartrnaire}" required>
                    <option value="En attente">En attente</option>
                    <option value="Réjetée" >Réjetée</option>
