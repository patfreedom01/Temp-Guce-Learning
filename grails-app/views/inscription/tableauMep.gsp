                    ...
                    <td>
                        <div class="actions">
                            <g:form method="DELETE" controller="inscription" action="delete" id="${thisInscription.id}">
                                ...
                                <g:link controller="inscription" title="Afficher" action="showMep" id="${thisInscription.id}" method="POST" >
                                    <i  >
                                        <span class='glyphicon glyphicon-eye-open'></span>
                                    </i>
                                </g:link>
                                <g:link controller="inscription"  title="Mettre à jour" action="editMep" id="${thisInscription.id}" method="POST" >
                                    <i >
