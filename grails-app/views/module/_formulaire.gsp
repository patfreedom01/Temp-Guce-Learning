<br>
<g:form resource="${this.module}" method="POST" class="form-horizontal form-normal form-left" action="save">
    <h3 style="color: #ff8000;">Gestion des modules</h3>
    ...
    <div class="col-md-7 col-lg-7">
        <div class="row">
            <div class="col-md-6">
                ...
                <select class="wfinput col-md-2 form-control form-input form-input-0" name="typeModule" id="slct1" onchange="lesModules(this.id,'slct2')" value="${module?.typeModule}" required>
                ...
                <br>
                <label >Module</label>
                <select class="wfinput col-md-2 form-control form-input form-input-0" name="nom" id="slct2" onchange="infoModule(this.id,'slct3')" value="${module?.nom}" required></select>
                <br>
                <br>
                <br>
                <br>
        ...
        <div class="row">
            <div class="col-md-8">
                <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="5"  placeholder="Objet de la planification de cette formation dans ce module" value="${module?.description}" ></textarea>
            </div>
        </div>
        <br>
    </div>
