...
<body>
<br>
<g:form resource="${this.module}" method="PUT" class="form-horizontal form-normal form-left" action="update">
    <h3 style="color: #ff8000;">Modifier un module</h3>
    <div class='container-fluid grid'>
        <div class='subnav subnav-operations subnav-static' role='navigation'>
            <div class='container-fluid'>
                <ul class='nav nav-pills'>
                    <div>
                        <input type="submit" class="save btn btn-create btn-success j_confirm" name="create" value="Enregistrer" id="create" value="${message(code: 'Sauvegarder', default: 'Sauvegarder')}"/>
    ...
    <div class="col-md-7 col-lg-7">
        <div class="row">
            <div class="col-md-6">
                ...
                <select class="wfinput col-md-2 form-control form-input form-input-0" name="typeModule" id="slct1" onchange="lesModules(this.id,'slct2')" value="${module?.typeModule}" >
                ...
                <br>
                <label >Module</label>
                <select class="wfinput col-md-2 form-control form-input form-input-0" name="nom" id="slct2" onchange="infoModule(this.id,'slct3')" value="${module?.nom}" ></select>
                <br>
                <br>
                <br>
                <br>
        ...
        <div class="row">
            <div class="col-md-8">
                <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3"  placeholder="Objet de la planification de cette formation dans ce module" value="${module?.description}" ></textarea>
            </div>
            <br>
            <br>
            <br>
