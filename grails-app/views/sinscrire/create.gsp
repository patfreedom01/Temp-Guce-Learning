...
<g:set var="entityName" value="${message(code: 'sinscrire.label', default: 'Demande')}" />
<g:applyLayout name="main">
    ...
    <div class="py-5">
        <h2 style="color : #ff8000 ">Formulaire demande de formation</h2>
        <p class="lead">Veuillez remplir le formulaire ci-dessous pour soumettre une demande de formation.</p>
    </div>
    <div class="row g-5">
        <br>
            ...
            <div class="col-md-7 col-lg-7">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select class="wfinput col-md-2 form-control form-input form-input-0" name="typeModule" id="slct1" onchange="lesModules(this.id,'slct2')" value="" >
                            <option value=""> -- choix -- </option>
                            <option value="prededouanement">PRE-DEDOUANEMENT</option>
                            <option value="dedouanement">DEDOUANEMENT</option>
                            <option value="logistique">LOGISTIQUE</option>
                            <option value="finance">FINANCE</option>
                            <option value="donnees">LES DONNEES</option>
                        </select>
                        <br>
                        <br>
                        <br>
                        <br>
                        <label >Module</label>
                        <select class="wfinput col-md-2 form-control form-input form-input-0" name="nom" id="slct2" onchange="description(this.id,'slct3')" value="" ></select>
                        <br>
                        <br>
                        <br>
                        <br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control mb-3" id="name" placeholder="" value="" >
                    </div>
                    <div class="col-md-4">
                        <label for="telephone" class="form-label">N°Téléphone</label>
                        <input type="text" class="form-control mb-3" id="telephone" placeholder="" value="" >
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <input type="email" class="form-control " id="email" placeholder="adresse@exemple.com">
                    </div>
                </div>
                <br>
                <div class="row mb-3">
                    ...
                    <div class="form-check col-md-4 ">
                        <input id="operateurEconomique" name="typeOperateur" type="radio" class="custom-control-input" >
                        <label class="form-check-label" for="operateurEconomique">Opérateur Economique</label>
                    </div>
                    <div class="form-check col-md-4">
                        <input id="ministereTechnique" name="typeOperateur"type="radio" class="custom-control-input" >
                        <label class="form-check-label" for="ministereTechnique">Ministère Technique</label>
                    </div>
                    <br>
                    <br>
                    <div class="col-md-10">
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"  placeholder="Un commentaire ?"></textarea>
                    </div>
                </div>
                <br>
                <button class="w-50 d-grid gap-2 col-md-4 mx-auto btn btn-success btn-lg" type="submit">Soumettre </button>
            </div>
        </form>
        <div class="col-md-5 col-lg-5 ">
            <span name="description" id="slct3" ></span>
        </div>
    </div>
</g:applyLayout>
